...
const  = () => {
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-gray-700">
          ...
          <div className="bg-gray-700/30 rounded-xl p-6 border border-gray-600 transition-all duration-300 hover:bg-gray-700/40 hover:border-gray-500 transform hover:-translate-y-1 mb-8">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-purple-400 hover:scale-105 transform transition-transform duration-300">
            ...
            {showServerConfig && (
              <div className="mb-4 p-4 bg-gray-800/50 rounded-lg border border-gray-600">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="ip" className="block mb-2 text-sm font-medium text-gray-300">
                      Server IP
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-2 bg-gray-700/50 border border-gray-600 rounded-lg text-gray-200"
                      placeholder="Enter server IP"
                    />
                  </div>
                  <div>
                    <label htmlFor="port" className="block mb-2 text-sm font-medium text-gray-300">
                      Port
                    </label>
                    <input
                      type="text"
 ...
 {/* Additional Parameters Section - Only shown when there are additional parameters */}
          ...
          <footer className="mt-8 text-center text-gray-500 text-sm">
            <p>VMES - Vac ML Experimental System</p>
            <p className="mt-1">Configure and manage your MLflow experiments efficiently</p>
          </footer>
        </div>
      </div>
    </div>
